<x-front-layout title="login">
    ...
    <x-slot name="breadcrumbs">
        <x-frontend.breadcrumbs page_title="Login">
            <x-frontend.breadcrumb-item href="{{ route('login') }}">Login</x-frontend.breadcrumb-item>
                    ...
                    <form class="card login-form" action="{{ route('login') }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group input-group">
                                <label for="reg-fn">{{ Config('fortify.username') }}</label>
                                <input class="form-control" type="text" id="reg-email"
                                    name="{{ Config('fortify.username') }}" required>
                            </div>
                            <div class="form-group input-group">
